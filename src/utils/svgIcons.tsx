// ---  CUTE Question MARK ICON ---
export const CuteQuestionMark = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-8 h-8 text-white/40 opacity-80 transition-colors duration-300">
    <circle cx="12" cy="12" r="10" className="stroke-white/10 fill-black/20" strokeWidth="1"/>
